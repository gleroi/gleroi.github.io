...
jenkins, ansible, outil historique de déploiement (interne à Enedis)

Déploiement::
réalisation des déploiements, synchronisation avec les équipes d'exploitation

Suivi opérationnel::
analyse et résolution des tickets remontés par les utilisateurs ou l'exploitant
